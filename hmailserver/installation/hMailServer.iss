...
Source: "..\..\..\Libs\OpenSSL-1.1.1n\out32\bin\libcrypto-1_1.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "..\..\..\Libs\OpenSSL-1.1.1n\out32\bin\libssl-1_1.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
