[Setup]
AppName=hMailServer
AppVerName=hMailServer 5.6.9-B2602.66a (x86)
AppCopyright=Copyright (C) 2023
DefaultDirName={pf}\hMailServer
DefaultGroupName=hMailServer
PrivilegesRequired=admin
OutputBaseFilename=hMailServer-5.6.9-B2602.66a-(x86)
...
Source: "..\..\..\Libs\openssl-1.1.1t\out32\bin\libcrypto-1_1.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "..\..\..\Libs\openssl-1.1.1t\out32\bin\libssl-1_1.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
